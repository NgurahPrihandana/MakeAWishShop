...
<div class="container" style="margin-top: 5rem;">
  ...
  <section class="category">
    ...
    <div class="col">
        <a href="<?=BASEURL?>/product/index" style="text-decoration: none;">
    ...
    <?php foreach($data['kategori'] as $k) :?>
      <div class="col">
        <a href="<?=BASEURL?>/product/categories/<?=$k['id_kategori']?>" style="text-decoration: none;">
          <div class="card h-100 <?=$data['id'] == $k['id_kategori'] ? "active" : ""?>" data-aos="zoom-in" data-aos-delay="100">
  ...
  <section class="list-product container mt-3">
    ...
    <?php foreach($data['productbyKategori'] as $p) :?>
