...
<nav class="navbar navbar-expand-lg navbar-light" style="position: fixed; top:0; left:0; width: 100%; z-index: 99; background: white;">
    <div class="container">
        <a class="navbar-brand" href="#"><img src="<?= BASEURL ?>/assets/images/icon/Fashion-logo.png" width="95px" alt=""></a>
            ...
            <form class="d-flex">
                <ul class="navbar-nav">
                    <li class="nav-item nav-link">
                        <a href="https://instagram.com/ngurah_prihandana227"><img src="<?= BASEURL ?>/assets/images/icon/instagram.svg" alt=""></a>
                    </li>
                    <li class="nav-item nav-link">
                        <a href="www.facebook.com"><img src="<?= BASEURL ?>/assets/images/icon/facebook.svg" alt=""></a>
                    </li>
                    <li class="nav-item nav-link">
                        <a href="www.twitter.com"><img src="<?= BASEURL ?>/assets/images/icon/twitter.svg" alt=""></a>
                    </li>
                </ul>
            </form>
        </div>
